...
Revision ID: a8248ebe1836
Revises: 
Create Date: 2023-05-23 11:37:58.181696
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_billing_funds_hold_user_uuid'), 'funds_hold', ['user_uuid'], unique=False, schema='billing')
    ...
    op.create_index(op.f('ix_billing_trans_order_payment_session_id'), 'trans_order', ['payment_session_id'], unique=False, schema='billing')
    op.create_index(op.f('ix_billing_trans_order_subscribe_id'), 'trans_order', ['subscribe_id'], unique=False, schema='billing')
    op.create_index(op.f('ix_billing_trans_order_user_uuid'), 'trans_order', ['user_uuid'], unique=False, schema='billing')
    ...
    op.create_index(op.f('ix_billing_transaction_user_uuid'), 'transaction', ['user_uuid'], unique=False, schema='billing')
    ...
    op.create_index(op.f('ix_billing_granted_access_user_uuid'), 'granted_access', ['user_uuid'], unique=False, schema='billing')
    ...
    op.create_index(op.f('ix_billing_granted_films_movie_uuid'), 'granted_films', ['movie_uuid'], unique=False, schema='billing')
